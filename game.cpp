...
Game::Game()
{
	...
	m_zoo.addAnimal(new Aigle("G�rard"));
...
void Game::RollsEvent()
{
	...
	case 5:
		//
		cout << "!!! Epid�mie de grippe aviaire !!!" << endl;
		cout << "> Chance de maladie des Aigles et des Poules + 10% pour ce mois-ci<" << endl;
		break;
	case 6:
		cout << "!!! Des nuisibles d�truisent nos stocks de graines !!!" << endl;
	...
	case 8:
		//
		cout << "!!! un incendie c'est d�clar� !!!" << endl;
		cout << "> vous perdez un habitat al�atoire et tous les animaux qui si trouvent <" << endl;
		break;
	case 9:
		//
		cout << "!!! AU VOLEUR! AU VOLEUR ! !!!" << endl;
		cout << "> des individues ce sont introduis dans le zoo pendant la nuit et ont d�rob� un animal <" << endl;
		cout << "> vous perdez un animal al�atoire <" << endl;
		break;
	case 10:
		cout << "!!! WooW, une star r�serve le zoo pour la journ�e ! !!!" << endl;
		cout << "> Aucune visiteur mais une belle prime d'enpoch� <" << endl;
		break;
	default:
